        ...
        <Box bg={"white"} mt={2} p={3}>
          <HStack>
            ...
            <Box>
              ...
              <Text>
                You can change or cancel this flight if plans change. Because
                flexibility matters.
              </Text>
            </Box>
          </HStack>
        ...
        <SimpleGrid mt={2} gridTemplateColumns={"63% 35%"} gap={"1%"}>
          ...
          <Box bg={"white"} textAlign={"left"} p={2}>
            <Image
              mb={1}
              width={"100%"}
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnO6ayEAREUNuZAwOudx0Nmzqd5kiLXxxIyOMMQxu3ebFR03vHq5xzk6U&s=10"
            />
            <Heading fontSize={"13px"}>8.8/10 Excellent (820 reviews)</Heading>
            <Heading fontSize={"13px"}>
              Guests rated this flight 9/10 for cleanliness
            </Heading>
            <Heading fontSize={"13px"}>
              Amenities: Wifi, Food, Entertainment
            </Heading>
            <Heading fontSize={"13px"}>Economy Class</Heading>
          </Box>
        </SimpleGrid>
